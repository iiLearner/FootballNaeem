          ...
          <div class="content col-md-8">
            ...
            <article class="card post post--single">
              ...
              <figure class="post__thumbnail">
                <img src="assets/images/football/samples/single-post-yoga.jpg" alt="">
              </figure>
              ...
              <div class="card__content">
                ...
                <header class="post__header">
                  <h2 class="post__title">A Cus Camerino si riprendono le Lezioni di Yoga</h2>
                  <ul class="post__meta meta">
                    <li class="meta__item meta__item--date"><time datetime="2018-05-02">May 02, 2018</time></li>
