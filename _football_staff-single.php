                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <div class="alc-staff__photo">
                            <img src="assets/images/football/samples/roster-player_06.jpg" alt="">
                          </div>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Massimiliano <span class="alc-staff__header-last-name">Allegri</span></h1>
                          ...
                          <dl class="alc-staff-details">
                            ...
                            <dd class="alc-staff-details__value">Livorno</dd>
                            ...
                            <dd class="alc-staff-details__value">Juventus</dd>

                            <dt class="alc-staff-details__label">Past Teams:</dt>
                            <dd class="alc-staff-details__value">AC Milan</dd>
                            ...
                            <dd class="alc-staff-details__value">2015, 2016, 2017, 2018</dd>
          ...
          <div class="sidebar col-md-4">
            ...
            <aside class="widget widget--sidebar widget-social">
              <a href="#" class="btn-social-counter btn-social-counter--fb" target="_blank">
                ...
                <h6 class="btn-social-counter__title">Allegri's Facebook Page</h6>
              ...
              <a href="#" class="btn-social-counter btn-social-counter--twitter" target="_blank">
                ...
                <h6 class="btn-social-counter__title">Allegri's Twitter Account</h6>
              ...
              <div class="widget__content card__content">
                <ul class="newslog">
                  ...
                  <li class="newslog__item newslog__item--injury">
                    <div class="newslog__item-inner">
                      <div class="newslog__content"><strong>Massimiliano Allegri</strong> will have a surgery and will be out for a month. Interim coach will be <strong>Antonio Conte</strong>.</div>
                  ...
                  <li class="newslog__item newslog__item--join">
                    <div class="newslog__item-inner">
                      <div class="newslog__content"><strong>Massimiliano Allegri</strong> is now the new <strong>Juventus Coach</strong> after a succesfull run in AC Milan.</div>
                      <div class="newslog__date">March 22, 2015</div>
                    </div>
                  </li>
                </ul>
              </div>
