      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-heading__title">Nuova Struttura In Palestra<span class="highlight">-Cus Camerino</span></h1>
          ...
          <div class="content col-md-8">
            ...
            <article class="card post post--single">
              ...
              <figure class="post__thumbnail">
                <img src="assets/images/football/samples/single-post-palestra.jpg" alt="">
              </figure>
              ...
              <div class="card__content">
                ...
                <header class="post__header">
                  <h2 class="post__title">La Palestra di Cus Camerino dispone di nuova attrezzatura di qualità</h2>
                  <ul class="post__meta meta">
                    <li class="meta__item meta__item--date"><time datetime="2018-06-10">June 10, 2018</time></li>
                ...
                <div class="post__content">
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                  ...
                  <h5>Un Percorso Difficile</h5>
                  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>

                  <div class="spacer"></div>

                  <figure class="aligncenter">
                    <img src="assets/images/football/samples/single-post-giocatore-palestra.jpg" alt="">
                    <figcaption>Atleti durante la pratica dei esercizi in Cus Camerino</figcaption>
                  </figure>
                ...
                <footer class="post__footer">
                  <div class="post__tags">
                    <a href="#" class="btn btn-default btn-outline btn-xs">Results</a>
                    <a href="#" class="btn btn-default btn-outline btn-xs">Incorporation</a>
                    <a href="#" class="btn btn-default btn-outline btn-xs">Finals</a>
                    <a href="#" class="btn btn-default btn-outline btn-xs">Uniforms</a>
                  </div>
                </footer>
            ...
            <div class="post-author post-author--avatar-left card">
              <div class="card__content">
                <figure class="post-author__avatar">
                  <img src="assets/images/football/samples/avatar-pettinari.jpg" alt="Post Author Avatar">
                </figure>
                <header class="post-author__header">
                  <div class="post-author__info">
                    <h4 class="post-author__name">Claudio Pettinari</h4>
                    <span class="post-author__slogan">Rettore Unicam</span>
                  </div>
                ...
                <div class="post-author__description">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidid ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud laboris.
                </div>
              </div>
            </div>
            <!-- Post Author / End -->
            ...
            <!-- Related Posts -->
            <div class="post-related post-related--condensed row">
              <div class="col-xs-6">
                <!-- Prev Post -->
                <div class="card post-related__prev">
                  <div class="card__content">
                    ...
                    <!-- Prev Post Links -->
                    <a href="#" class="btn-nav btn-nav--condensed">
                    ...
                    <ul class="posts posts--simple-list">
                      <li class="posts__item posts__item--category-1">
                        <div class="posts__inner">
                          ...
                          <time datetime="2018-05-08" class="posts__date">June 08, 2018</time>
                        </div>
                      </li>
                    </ul>
                    ...
                    <ul class="posts posts--simple-list">
                      <li class="posts__item posts__item--category-3">
                        <div class="posts__inner">
                          ...
                          <h6 class="posts__title"><a href="#">Federica Pelegrini diventa nuova sensazione del nuoto Italiano</a></h6>
